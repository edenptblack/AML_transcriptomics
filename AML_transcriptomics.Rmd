...
The combined expression filter is applied, then DEGs are called as probesets with p < 0.05 and |log2 fold change| > 1.
...
The limma results are joined to the summary-statistics table and put through the same filters as the t-test approach, for a like-for-like comparison: mean > 3 in both groups, max < 14 in at least one group, p < 0.05, and |log2 fold change| > 1.
